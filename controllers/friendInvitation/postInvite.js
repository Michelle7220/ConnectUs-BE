...
const postInvite = async (req, res) => {
    ...
    const { userId, mail } = req.user;
      ...
      //mail is the login mail , targetMailAddress is the one I want to invite
  ...
  //find if the one we want to invite is in the database
 ...
 const usersAlreadyFriends = targetUser.friends.find(
  ...
  //if inivitation has been successfully created we would like to update friends invitation is the friend is online
